...
describe TransferVerification do
	...
	describe 'validations' do
		...
		let(:checksum) { Checksum.create!(transfer_source: transfer_source, checksum_algorithm: checksum_algorithm, value: checksum_value) }
		...
		context "data does not match source data" do
